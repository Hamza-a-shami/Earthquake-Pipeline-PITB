...
├── dashboard_queries.sql    # SQL queries used by Tableau
...
The `old_data.py` script downloads earthquake data from the previous 30 days and inserts it into PostgreSQL.
